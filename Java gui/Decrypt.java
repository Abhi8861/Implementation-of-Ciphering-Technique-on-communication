...
public class Decrypt extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("The Plain text is:");
        ...
        jLabel1.setText("Enter the cipher text recieved:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String ciptext;
        ciptext = plaintext.getText();
        String cypherkey;
        cypherkey = key.getText();
        Crypter c=new Crypter();
        String decryp = Crypter.decipher(ciptext,cypherkey);
        cypher.setText(decryp);
